  ...
  return (
    ...
    >
      <div className=" container mx-auto py-12">
        ...
        <p className="pt-5 px-5 lg:px-0 text-lg lg:text-center text-left">
          SERP has relentlessly worked on a unique structure
          of community based organization by organizing <b className="text-[#C4161B]">69,31,113</b> rural women
          into <b className="text-[#C4161B]">6,52,440</b> SHGs,<br className="hidden lg:block"/> <b className="text-[#C4161B]">26,753</b> Village Organizations, <b className="text-[#C4161B]">656</b> Mandal Samakhyas
          and <b className="text-[#C4161B]">13</b> Zilla Samakhyas.
        </p>
      </div>
